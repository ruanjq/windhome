...
// 读取.md 文件YAML front matter title 内容或者sideBarTitle 内容设置导航栏标题
...
// console.log(readDocsTitle(path.resolve(__dirname,"../../front/README.md")));


function splitPath(p) {
    return p.replace(/\\/g,"/").match(/docs(.*)/)[1];
}
